...
<body>
	<p>convert google redirects to original url. <span class="xxsmall">(version: <TMPL_VAR NAME="version">; report bugs at <a href="http://meta.wikimedia.org/wiki/user_talk:lustiger_seth" class="external">meta:user talk:lustiger_seth</a>)</span></p>
	<form name="urlform" method="post" action="<TMPL_VAR NAME="cgi_script">">
		<fieldset><legend><span class="smallbold">.url</span></legend>
			<label for="url">type in url<br />(e.g. "http://www.google.com/url?url=http%3A%2F%2Fen.wikipedia.org"):<br /><br /></label>
